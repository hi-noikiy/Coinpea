        ...
        return (
            <div className="block">
                <div className="block-top">
                    ...
                    <p>{intl.get('Banner-des-1')+this.state.data.coinName +' '+intl.get('Banner-des-2')}</p>
                </div>
                <div className="block-bottom">
                        <div className="block-items">
                            <div>
                                ...
                                <div>
                                    ...
                                    <p className={cs('p-small')}>
                                       {/*  <i></i> */}
                                        ...
                                        <a href="/" className="banner-link" target="_blank">{intl.get('Bnner-r-link1')}</a>
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p className={cs('p-small')}>
                                       {/*  <i></i> */}
                                        ...
                                        <a href="/" className="banner-link" target="_blank">{intl.get('Bnner-r-link2')}</a>
                                    </p>
                                </div>
                            </div>
