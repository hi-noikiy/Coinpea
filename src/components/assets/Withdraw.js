...
import { setPrecision, addTotal, precision_zero } from '../../utils/index'
...
class Withdraw extends React.Component {
    ...
    isShowAddAddressHandle = (e) => {
       ...
       !this.state.showList&& this.GetWithdrawAddr(this.props.allCoins.activeCoinid);
    ...
    showAddAddress = (e) => {
       ...
       if(this.state.isShowAddAddress) return false;
       this.setState({
    ...
    selectAdd = (index) => {
        this.setState({
            addr: this.state.list[index].address
        });
